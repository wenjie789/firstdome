        ...
        <i @click="sousuo(1)" style="font-size:35px;" class="el-icon-search"></i>
            ...
            <el-main>
               ...
               <el-table-column
                ...
                <img style="width:80px;height:80px;border:none;"  :src="http+'webdownload/picdownload?fileId='+userinfo.row.recordPhoto+'&temp=6'">
                </template>
                </el-table-column>
               <el-table-column
               style="color:red"
    ...
    methods:{
        ...
        initUser(){
          this.sousuoY=1
            ...
            //  console.log(resp)
              // if(resp.data.object.version=='超时未归'){
