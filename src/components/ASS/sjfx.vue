<template>
    <div>
       <el-container>
            <el-header>
               <div class="a1">
                <span class="font">数据分析-历史记录</span>
                <span class="font1">关键指标:</span>
                <el-button>跌倒人次</el-button>
                <el-button>深蹲人次</el-button>
                <el-button>久坐不动人次</el-button>
                <el-button>徘徊人次</el-button>
                <el-button>大门出入人次</el-button>
                <el-button>电梯出入人次</el-button>
                <el-button>触发报警次数</el-button>
                <div class="a1">
